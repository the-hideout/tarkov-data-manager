...
export const getUsers = scannerFramework.getUsers;

export const getScanner = scannerFramework.getScanner;

export const refreshScannerUsers = scannerFramework.refreshUsers;

export default scannerFramework;
