...
DOMAIN=cache.tarkov.dev # the domain to serve traffic with
REPO_DIR=/home/cache/cache # the repo to clone and use for the app deployment
VM_USER=cache # the name of the vm user
REPO_NAME=cache # the name of the repo to clone
ORG_NAME=the-hideout # the name of the organization to use for the repo
